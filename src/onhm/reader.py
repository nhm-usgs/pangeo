...
def get_ts_for_box(ds_out, lat_min, lat_max, lon_min, lon_max, var):
    lat = ds_out.hru_lat
    ...
    lons_sel = sel_2.values
    
    sel_3 = lat.sel(hruid=ids_2)
    lats_sel = sel_3.values
    
    vals = var.sel(hruid=ids_2)
    
    return ids_2, lats_sel, lons_sel, vals
